        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <a href="<?php echo $enlace; ?>" target="_blank">
              <img class="img-responsive publicidad-escritorio" src="<?php echo $imagen_escritorio; ?>" style="object-fit:contain; width:100%; height: 70vh; vertical-align: middle;" alt="banner">
